...
=== 今日のAIレッスン ===
(毎日必ず入れる常設コーナー。ニュースとは独立した「AI活用の学び」を毎日1つだけ教える。3分。
聴き終わった人がその日のうちに1回試せる、具体的な練習を出す。
例: AIへの上手な頼み方の型、クレーム返信の下書きを頼む練習、会議メモの要約、
写真から販促文を作る、売上数字を貼って分析させる、など。
初心者向けに、実際に打ち込む言葉の例をそのまま声に出して読み上げる。
「今日の宿題はこれです。◯◯とAIに打ってみてください」と締める。)
